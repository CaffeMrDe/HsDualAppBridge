...
bool RobConnUI::callback_rbConnCommand(rbconnui_bridge::rb_DoubleBoolRequest& request,rbconnui_bridge::rb_DoubleBoolResponse& response){
...
bool RobConnUI::callback_rbRunCommand(rbconnui_bridge::rb_DoubleBoolRequest& request,rbconnui_bridge::rb_DoubleBoolResponse& response){
    for (int i = 0; i < 99999; ++i) {
        if(request.request){
            cout<<"--"<<i<<"收到请求"<<endl;
        }
...
bool RobConnUI::callback_magicGetDatapCommand(rbconnui_bridge::rb_DoubleBoolRequest& request,rbconnui_bridge::rb_DoubleBoolResponse& response){
    for (int i = 0; i < 99999; ++i) {
        if(request.request){
            cout<<"--"<<i<<"收到请求"<<endl;
        }
...
bool RobConnUI::callback_magicSolveCommand(rbconnui_bridge::rb_DoubleBoolRequest& request,rbconnui_bridge::rb_DoubleBoolResponse& response){
    for (int i = 0; i < 99999; ++i) {
        if(request.request){
            cout<<"--"<<i<<"收到请求"<<endl;
        }
...
bool RobConnUI::callback_magicRunSolverCommand(rbconnui_bridge::rb_DoubleBoolRequest& request,rbconnui_bridge::rb_DoubleBoolResponse& response){
    for (int i = 0; i < 99999; ++i) {
        if(request.request){
            cout<<"--"<<i<<"收到请求"<<endl;
        }
...
bool RobConnUI::callback_rbGrepSetCommand(rbconnui_bridge::rb_ArrayAndBoolRequest& request,rbconnui_bridge::rb_ArrayAndBoolResponse& response){
    for (int i = 0; i < 99999; ++i) {
        cout<<"--"<<i<<"收到请求"<<endl;
    }
